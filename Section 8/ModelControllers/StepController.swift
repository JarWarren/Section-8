    ...
    func addItemsToSteps() {
        ...
        for step in steps {
            ...
            case "STEP 1":
                ...
                // Item 1A
                ItemController.addNewItem(title: nil, text: "Fill out the preliminary application by clicking the button below, but read these instructions first:", buttonText: nil, url: nil, format: .paragraph, step: step)
                
                // Item 1B
                ItemController.addNewItem(title: "VIEWING TIP", text: "It might be easier to turn your phone sideways, so the application is easier to read.", buttonText: nil, url: nil, format: .tip, step: step)
                
                // Item 1C
                ItemController.addNewItem(title: "APPLICATION RECEIPT", text: "When finished, you will see an “Application Receipt” screen. Take a screenshot and save it.", buttonText: nil, url: nil, format: .tip, step: step)
...
//                ItemController.addNewItem(title: nil, text: "(1E) When you’re ready, click here to be taken to the online application on the HAUC website:", buttonText: "PRELIMINARY APPLICATION", url: "https://www.waitlistcheck.com/application/form.php?ID=972-UT011", format: .clickLink, step: step)
            ...
            case "STEP 2":
                ...
                // Item 2A
                ItemController.addNewItem(title: nil, text: "After submitting your preliminary application online, the head of household takes a photo ID and social security card to the Housing Authority of Utah County (HAUC) main office.", buttonText: nil, url: nil, format: .paragraph, step: step)
                
                // Item 2B
                ItemController.addNewItem(title: "HOUSING AUTHORITY (HAUC) OFFICE INFORMATION", text: "240 E Center St \nProvo, UT 84606 \nHours: Monday – Thursday, 7:30am to 5:30pm \nPhone: 801-373-8333", buttonText: nil, url: nil, format: .tip, step: step)
                
                // Item 2C
                ItemController.addNewItem(title: nil, text: "Once the head of household has taken these two forms of identification in to the HAUC office, this step is complete!", buttonText: nil, url: nil, format: .paragraph, step: step)
                
                // Item 2D
                ItemController.addNewItem(title: "WAITING LIST", text: "Once you have completed this step, you will be placed on a waiting list, and the wait time is from TWO MONTHS up to MORE THAN A YEAR. \n\nBe patient, and make sure to update your phone number and mailing address with the Housing Authority if anything changes!", buttonText: nil, url: nil, format: .tip, step: step)
